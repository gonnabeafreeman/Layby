...
final class L10n {
    ...
    private static let english: [String: String] = [
        ...
        "在菜单栏显示": "Show in menu bar", "自动检查更新": "Automatically check for updates", "开机自启动": "Launch at Login",
        "登录 Mac 后自动启动 Layby。": "Automatically launch Layby after you log in to your Mac.",
        "需要在系统设置的“登录项与扩展”中允许 Layby。": "Allow Layby in Login Items & Extensions in System Settings.",
        "打开登录项设置": "Open Login Items Settings", "当前无法配置开机自启动。": "Launch at login is currently unavailable.",
        "无法更新开机自启动设置：%@": "Could not update launch at login: %@",
        ...
        "启用快捷键": "Enable shortcut", "新建停放区": "New Shelf",
        "点击键位后按下新组合键，Esc 取消。": "Click the shortcut, then press a new combination. Esc cancels.",
        "拖出文件": "Dragging Files Out", "按住": "Hold", "剪贴操作快捷键": "Shortcut for moving files",
        "拖出文件执行剪贴操作": "while dragging files out to move them",
        "普通拖出会复制文件；剪贴仅适用于拖到 Finder 的原文件，临时文件不支持剪贴原件。": "Regular drags copy files. Moving originals works when dropping into Finder; temporary files cannot move their source originals.",
        "按住 %@ 拖到 Finder 以移动原文件": "Hold %@ while dragging to Finder to move the original",
        ...
        "已移动 %d 个文件": "Moved %d files",
        "移动未完成；原文件仍在原位置。": "The move did not finish; the originals remain in place.",
        "已移动 %d 个文件；其余原文件仍在原位置。": "Moved %d files; the remaining originals are still in place.",
        "原文件未发生移动": "Original files were not moved.",
        "来源应用生成的临时文件不能移动原件；松开移动键后可复制拖出。": "A temporary file from another app cannot move its original. Release the move key to drag out a copy.",
        "部分文件无法提供给目标，移动已取消。": "Some files could not be supplied to the destination. The move was cancelled.",
