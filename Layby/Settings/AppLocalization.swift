...
final class L10n {
    ...
    private static let english: [String: String] = [
        ...
        "拖出文件": "Dragging Files Out", "移动拖出快捷键": "Move-drag shortcut",
        "按住 %@ 拖到 Finder 以移动原文件": "Hold %@ while dragging to Finder to move the original",
        "默认复制；按住该键开始拖拽到 Finder，可移动原文件。来源应用生成的临时文件不支持移动原件。": "Dragging copies by default. Hold this key when starting a drag to Finder to move the original. Temporary files supplied by other apps cannot move their originals.",
